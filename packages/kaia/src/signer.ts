...
/** Default BIP44 HD path for Kaia (coin type 8217). */
export const KAIA_DEFAULT_PATH = "m/44'/8217'/0'/0/0"
...
/**
 * Kaia signer implementing the ChainSigner interface.
 * Kaia uses the same Secp256k1 cryptography and transaction format as Ethereum,
 * with a different BIP44 coin type (8217 instead of 60).
 *
...
export class KaiaSigner implements ChainSigner {
   ...
   * Default path: m/44'/8217'/0'/0/0 (Kaia coin type 8217).
  ...
  /**
   * Get the Kaia address for a given private key.
   * Returns an EIP-55 checksummed address (same format as Ethereum).
   */
